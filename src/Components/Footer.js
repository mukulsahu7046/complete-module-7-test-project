  ...
  return (
    <div className='footer'>
        <div className='upper'>
            ...
            <div className='mid'>
                <div className='row-1'>
                    <p className='headtitle'>Company Info</p>
                    <p className='p1'>About Us</p>
                    <p className='p1'>Carrer</p>
                    <p className='p1'>We are hiring</p>
                    <p className='p1'>Blog</p>
                </div>
                <div className='row'>
                    <p className='headtitle'>Legal</p>
                    <p className='p1'>About Us</p>
                    <p className='p1'>Carrer</p>
                    <p className='p1'>We are hiring</p>
                    <p className='p1'>Blog</p>
                ...
                <div className='row'>
                    ...
                    <p className='p1'>Business Marketing</p>
                    <p className='p1'>User Analytics</p>
                    <p className='p1'>Live Chat</p>
                    <p className='p1'>Unlimited Support</p>
                </div>
                <div className='row'>
                    <p className='headtitle'>Resources</p>
                    <p className='p1'>IOS & Android</p>
                    <p className='p1'>Watch a demo</p>
                    <p className='p1'>Customers</p>
                    <p className='p1'>API</p>
                </div>
                <div className='row'>
                    <p className='headtitle'>Get In Touch</p>
                    
                    <div className='input'>
                        <form onSubmit={handleSubmit}>
                            <input type='text' placeholder='Your Email' className="inp" onChange={handleEmailChange}/>
                            <button className='sub-btn' type='submit'>Subscribe</button>
                        </form>
                    </div>
                    
                    <p className='para-grey'>Lorem ipsum dolor bazinga</p>
                </div>
            </div>
        </div>
        <div className='foot'>
            <p className='footernote'>Made With &#10084;&#65039; at AccioJob</p>
        </div>
    </div>
  )
}
