                            ...
                            products?.map((current) => {
                                return (
                                        <div className='ccc'>
                                            <div className='cc'>
                                                <div className='imggg'>
                                                    <img className='ima' src={current.productImage} alt= 'no img found' />
                                                 </div>
                                                <div className='title'>
                                                ...
                                                <div className='prices'>
                                                    <div className='stars'>
                                                        <svg className='starsss' width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <p className='oPrice'>{current.oldPrice}/-</p>
                                                        <p className='nprice'>{current.newPrice}/-</p>
                                                    </div>
                                                    <div className='btn1'>
                                                        <button className='btncarting' onClick = {increaseValue} >ADD TO CART</button>
                                                    </div>
                                            </div>
                                        </div>
                                        )
